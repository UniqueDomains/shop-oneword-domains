...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C730%20rows-8250df">
...
**Public extract:** 1,730 rows · **Live catalog:** 1,688 domains
...
- `shop.csv` — public CSV extract (1,730 rows)
- `shop.json` — public JSON extract (1,730 rows)
...
| ----------------------- | ------------------------------------------------ |
| 1,730-row public sample | 1,688 live domains                               |
