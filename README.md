...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C653%20rows-8250df">
...
> **Important:** this repository is a **public 1,653-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,006 domains** on the canonical page below.

**Public extract:** 1,653 rows · **Live catalog:** 5,622,006 domains
...
- `shop.csv` — public CSV extract (1,653 rows)
- `shop.json` — public JSON extract (1,653 rows)
...
| ----------------------- | ------------------------------------------------ |
| 1,653-row public sample | 5,622,006 live domains                           |
...
> Unique Domains. *Available .SHOP One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
